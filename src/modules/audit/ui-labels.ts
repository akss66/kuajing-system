const auditActionLabels: Record<string, string> = {
  ...
  JIFENG_CANCELLED_REMOTE_STATUS_CONFLICT: "本地取消与极风状态冲突",
  JIFENG_FULFILLMENT_EXCEPTION: "极风仓库处理异常",
  JIFENG_EXISTING_ORDER_MATCHED: "极风已有订单匹配成功",
  JIFENG_EXISTING_ORDER_MATCH_FAILED: "极风已有订单匹配失败",
  JIFENG_EXISTING_ORDER_MATCH_WAITING: "等待极风已有订单",
  ...
  OFFLINE_PAYMENT_CLAIM_INVALIDATED_BY_SHIPMENT_CANCELLATION: "包裹取消后付款申报失效",
  ORDER_OFFLINE_REFUNDS_COMPLETED: "拿货单线下退款已全部完成",
  REPLACEMENT_CREATED: "补发创建",
  SHIPMENT_CANCELLATION_ADJUSTMENT_CREATED: "包裹取消金额调整创建",
  SHIPMENT_OFFLINE_REFUND_COMPLETED: "包裹线下退款已完成",
  SETTLEMENT_CANCELLED: "批量付款已关闭",
  SETTLEMENT_EXPIRED: "批量付款已超时",
  SETTLEMENT_INVALIDATED_BY_PACKAGE_CANCELLATION: "包裹取消后批量付款金额失效",
  SETTLEMENT_PAID: "批量付款已收款",
  SETTLEMENT_PAYMENT_APPROVED: "批量付款已核准",
  SETTLEMENT_PAYMENT_EXPIRED: "批量付款申报已过期",
  SETTLEMENT_PAYMENT_REJECTED: "批量付款申报已拒绝",
  SETTLEMENT_PAYMENT_REPORTED: "批量付款已申报",
  SETTLEMENT_PAYMENT_WITHDRAWN: "批量付款申报已撤回",
  ...
  WALLET_SHIPMENT_REFUNDED: "包裹余额退款",
  WALLET_SETTLEMENT_DEBITED: "批量付款余额扣款",
  WALLET_SETTLEMENT_HELD: "批量付款余额冻结",
  WALLET_SETTLEMENT_HOLD_CONSUMED: "批量付款冻结已抵扣",
  WALLET_SETTLEMENT_HOLD_RELEASED: "批量付款冻结已释放",
};
