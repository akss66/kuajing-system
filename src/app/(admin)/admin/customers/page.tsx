...
export default async function CustomersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ActionForm action={createCustomerWithStoreAction} className="grid gap-4 rounded-[var(--radius-surface)] border border-border bg-background p-4 sm:grid-cols-2 xl:grid-cols-[0.8fr_1.1fr_1.1fr_1.2fr_1.1fr_1.5fr_auto] xl:items-end xl:p-5" submitLabel="创建客户与店铺">
        ...
        <label className="space-y-2 text-sm font-medium text-ink">创建原因<Input className="min-h-11" maxLength={500} name="reason" placeholder="说明为什么要创建该客户账号" required /></label>
      </ActionForm>
