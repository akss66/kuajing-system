...
export default function CustomerPortalNotFound() {
  return (
    <section aria-labelledby="portal-not-found-title" className="mx-auto max-w-2xl rounded-[var(--portal-surface-radius)] border border-border bg-background px-5 py-8 sm:px-8">
      ...
      <Link className="portal-page-primary mt-6 inline-flex min-h-12 items-center gap-2 rounded-[0.7rem] bg-primary px-5 text-sm font-semibold text-white" href="/portal"><ArrowLeft aria-hidden="true" className="size-4" />返回客户首页</Link>
    </section>
  );
}
